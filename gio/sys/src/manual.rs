...
#[cfg(target_family = "windows")]
mod windows_streams {
    use crate::{gboolean, GInputStream, GInputStreamClass, GOutputStream, GOutputStreamClass, GType};
    use libc::c_void;
    ...
    extern "C" {
        ...
        pub fn g_win32_input_stream_new(handle: *mut c_void, close_handle: gboolean) -> *mut GInputStream;
        ...
        pub fn g_win32_input_stream_set_close_handle(stream: *mut GWin32InputStream, close_handle: gboolean);

        //=========================================================================
        // GWin32OutputStream
        //=========================================================================
        pub fn g_win32_output_stream_get_type() -> GType;
        pub fn g_win32_output_stream_new(handle: *mut c_void, close_handle: gboolean) -> *mut GOutputStream;
        ...
        pub fn g_win32_output_stream_set_close_handle(stream: *mut GWin32OutputStream, close_handle: gboolean);
    }
